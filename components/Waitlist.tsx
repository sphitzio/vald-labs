    ...
    <section id="waitlist" className="py-24 px-6 bg-zinc-950 border-t border-white/5">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <form className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto" onSubmit={(e) => e.preventDefault()}>
            ...
            <button className="h-12 bg-white text-black px-6 rounded-md font-space-mono font-bold hover:bg-[#ffff00] transition-colors flex items-center justify-center gap-2 group whitespace-nowrap">
